...
import { paginateAssetsByLimits, sortAssetsByPrice } from '../../store/penny-stock-explorer-reducer/etoro-assets-reducer/etoro-assets-slice'
...
const SortContainer = () => {
  ...
  return (
    <div className={styles.sortContainer}>
      ...
      >
        {isAscendingSort ? <ArrowUpwardIcon sx={{ width: 15, height: 15 }} /> : <ArrowDownwardIcon sx={{ width: 15, height: 15 }} />}
      </div>
    </div>
  )
}
